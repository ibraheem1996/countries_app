...
return loaded(_that.detailsModel);case Error() when error != null:
...
return loaded(_that.detailsModel);case Error():
return error(_that.failure);case _:
  throw StateError('Unexpected subclass');
...
class Loading implements DetailsState {
  const Loading();
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is Loaded&&const DeepCollectionEquality().equals(other._detailsModel, _detailsModel));
}


@override
int get hashCode => Object.hash(runtimeType,const DeepCollectionEquality().hash(_detailsModel));

@override
String toString() {
  return 'DetailsState.loaded(detailsModel: $detailsModel)';
}
...
/// @nodoc
abstract mixin class $LoadedCopyWith<$Res> implements $DetailsStateCopyWith<$Res> {
...
class Error implements DetailsState {
...
@override
String toString() {
  return 'DetailsState.error(failure: $failure)';
}
...
/// @nodoc
abstract mixin class $ErrorCopyWith<$Res> implements $DetailsStateCopyWith<$Res> {
